  ...
  mutations: {
    ...
    deleteSubCategory(state, id) {
      state.subCategories = state.subCategories.filter(
        (res: any) => res.sub_category_id !== id
      );
    },
      ...
      await AxiosService.endPoint()
        ...
        .catch((error) => {
          ...
          alertBulma(
            'warning',
            'Error',
            'No se pudieron cargar las sub categorías, por favor recargue la página'
          );
        });
    },
    ...
    postSub({ dispatch }, data) {
      return new Promise((resolve, reject) => {
        AxiosService.endPoint()
          .post(`/category/sub/${data.category}`, data)
          .then((res) => {
      ...
      await AxiosService.endPoint()
        ...
        .catch((error) => {
          alertBulma(
            'warning',
            'Error',
            'No se pudieron cargar las categories, por favor recargue la página'
          );
        });
    },
